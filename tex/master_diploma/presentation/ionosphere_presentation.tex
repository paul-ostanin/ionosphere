...
\center{
\includegraphics[scale=0.45]{30sec} \\Рис. 4. Ошибка в вычислении стационарного состояния в трёхмерной задаче с учётом нейтрального ветра при шаге по времени $\tau = 30$~с.
}
\end{frame}
