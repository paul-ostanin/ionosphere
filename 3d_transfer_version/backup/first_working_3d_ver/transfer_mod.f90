...
!    open (20, file = 'res/res_adv.dat', status = 'replace', access = 'direct', form = 'unformatted', recl = Nx1*Ny1*Nz1)
!    uinp(1:Nx1, 1:Ny1, 1:Nz1) = u(1:Nx1, 1:Ny1, 1:Nz1, 1)
!    write(20, rec = nrec)uinp
!    print*,uinp
...
!    uout(1:Nx1, 1:Ny1, 1:Nz1) = u(1:Nx1, 1:Ny1, 1:Nz1, 1)
    ...
    do n = 1, 1!Nt**************************
        ...
        call forcing_calc(Nx, Ny, Nz, Nx1, Ny1, Nz1, fu, arr_inc, dt)
