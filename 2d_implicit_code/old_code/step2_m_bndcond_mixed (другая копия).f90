...
do j = 1, Nphi
    ...
    F_ub.d(j) =  0*D.d(z.n-1)*(sI**2)*df_dz(z.d(z.n)-h0/200, phi) + 0*u_analytical(z.d(z.n)-h0/200)*(sI**2)*f_m(z.d(z.n)-h0/200, phi) - 1/R*sI*cI*D.d(z.n-1)*df_dphi(z.d(z.n)-h0/200, phi)*mixed_z_switch
    ...
    !write(700, *) (j-5E-1)*180/(Nphi)-90, F_ub.d(j)
    ...
    do i = 1, Nz
        do j = 1, Nphi
            ...
            if (i == 1) then
                ...
                do s_i = -1, 1
                    do s_j = -1, 1
                        operator(s_i, s_j) = 0*diffusion_transfer_z(s_i, s_j) + mixed_z_switch*mixed_z(s_i, s_j)
                    enddo
                enddo
