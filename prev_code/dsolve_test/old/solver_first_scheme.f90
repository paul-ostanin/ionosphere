...
type (vect) b, z, nO, nO2, nN2, res, k, p, njold, njnew, nday, nnight, delta, D, u, Tn, Ti, Te, Tr, Tp, gradTp
integer ios, i, j
...
call D.init(z.n - 1)
do i = 1, z.n - 1
	D.d(i) = 3E+17 * Tp.interp(z, 0.5*(z.d(i)+z.d(i+1))) / (nO.interp(z, 0.5*(z.d(i)+z.d(i+1))) * sqrt(Tr.interp(z, 0.5*(z.d(i)+z.d(i+1)))))
end do
